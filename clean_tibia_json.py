...
def clean_tibia_json(json_file_path: str) -> None:
    """
    Remove itens indesejados dos arquivos JSON da Tibia.
    """
    ...
    print(f"Removidos {removed_count} itens de {json_file_path}")
...
def main():
    ...
    for json_file in json_files:
        ...
        if file_path.exists():
            clean_tibia_json(str(file_path))
        else:

#!/usr/bin/env python
"""
Script para recuperar todas as URLs das Gloves do Counter-Strike no Cloudinary

Uso:
    python get_gloves_urls.py
...
FOLDER_NAME = 'cs/gloves'  # Pasta cs/gloves
...
def save_output(content, format_type='json'):
    ...
    # Nome do arquivo: gloves_urls.json
    filename = f"gloves_urls{extensions.get(format_type, '.txt')}"
...
def main():
    print("=" * 70)
    print("☁️  CLOUDINARY URL EXTRACTOR - CS GLOVES")
    print("=" * 70)
    print()
    ...
    print(f"📊 RESUMO")
    print("=" * 70)
    print(f"✅ Total de gloves: {len(resources)}")
    ...
    print()
    print("=" * 70)
    print("📋 PREVIEW (primeiros 10 gloves)")
    print("=" * 70)
    ...
    if len(resources) > 10:
        print(f"... e mais {len(resources) - 10} gloves")
